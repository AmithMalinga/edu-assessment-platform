                    ...
                    >
                        ...
                        >
                            ...
                            <div className="min-w-[80px]">
                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">සමත් වීමේ ප්‍රතිශතය</div>
                        ...
                        >
                            ...
                            <div className="min-w-[80px]">
                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider font-sinhala">ප්‍රශ්න</div>
                                <div className="text-xl font-black dark:text-white font-sans">
