    ...
    return (
        <header className="h-20 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 sticky top-0 z-40">
            ...
            <div className="flex items-center gap-4">
                <button className="p-2 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors relative">
                ...
                {/* Profile */}
                <button className="flex items-center gap-3 pl-2 pr-1 py-1 rounded-full hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
                    <div className="text-right hidden sm:block">
                        <p className="text-sm font-bold text-slate-900 dark:text-white leading-tight">Amith Malinga</p>
                        <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">A/L Student</p>
                    </div>
                    <div className="relative h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 p-0.5">
                        <div className="h-full w-full rounded-full border-2 border-white dark:border-slate-950 bg-slate-200 overflow-hidden relative">
                             <Image 
                                src="https://ui-avatars.com/api/?name=Amith+Malinga&background=6366f1&color=fff" 
                                alt="Avatar" 
                                fill
