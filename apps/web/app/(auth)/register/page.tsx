...
export default function RegisterPage() {
    ...
    const validate = () => {
        ...
        if (!isValidPhone(phone)) errors.phone = "Valid phone is required (minimum 10 digits)."
        ...
        if (!isStrongPassword(password)) errors.password = "Min 8 chars with uppercase, lowercase, and number."
        return errors
    }
                ...
                <form onSubmit={handleRegister} className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <Select value={educationalLevel} onValueChange={setEducationalLevel} disabled={isLoading}>
